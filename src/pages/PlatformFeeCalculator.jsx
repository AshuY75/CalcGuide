    ...
    return (
        <div className="min-h-screen bg-slate-50">
            <SchemaGenerator
                ...
                description="Calculate net earnings after platform fees and currency conversion for PayPal, Upwork, and Fiverr."
                url="https://calcguide.in/calculators/creator/platform-fee-calculator/"
            />
