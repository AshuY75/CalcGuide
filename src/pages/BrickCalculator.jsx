    ...
    return (
        <div className="min-h-screen bg-slate-50">
            <SchemaGenerator
                ...
                description="Estimate the number of bricks, cement bags, and sand required for your construction project."
                url="https://calcguide.in/calculators/construction/brick-calculator/"
            />
