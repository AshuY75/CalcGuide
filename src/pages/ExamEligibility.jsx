            ...
            <div className="bg-white border-b border-slate-200 py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="text-sm text-slate-500 mb-2">
                        ...
                        <span className="mx-2">›</span>
                        <span className="text-slate-900">Exam Eligibility</span>
                    </nav>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="md:col-span-2 space-y-8">
                        ...
                        <CalculatorContent
                            ...
                            whatIs="This calculator helps job aspirants check if they meet the strict age criteria for Government Exams like UPSC, SSC CGL, IBPS PO, and Railways. It compares your DOB against the official 'Cut-off Date' mentioned in the exam notification."
                            whoShouldUse="Students preparing for Competitive Exams. Official notifications often state 'Age as of 1st Jan 2025' which can be confusing to calculate manually."
                            example="If you were born on 2 Feb 1998 and proper eligibility requires 'Age less than 27 as on 1 Jan 2025', you are eligible. But if the cut-off date is 1 Aug 2025, you might be over-age. Check instantly here."
                            commonMistake="Ignoring the specific 'Cut-off Date'. Many candidates assume their age is calculated on the day they fill the form. It is NOT. It is always calculated on the date mentioned in the official PDF."
                        />
